...
public class ShareVideo extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			String emailForm = "nganptkpd07748@fpt.edu.vn";
			String passFrom = "jmckpfxnvcqyvrrd";
			...
			if (videoId == null) {
				...
				email.setSubject("Chia sẻ video đến bạn | NGHIENPHIM");
				...
				String msg = "<div style='width:50%;margin:0 auto'>"
						...
						+ "Copyright © 2022 <b>NghienDT</b>. All rights reserved.</div></div></div>";
